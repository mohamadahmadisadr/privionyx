...
#ifndef PRIVIONYX_SWIFT_H
#define PRIVIONYX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="privionyx",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ReceiptManagedObject")
@interface ReceiptManagedObject : NSManagedObject
@property (nonatomic, copy) NSUUID * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull merchant;
@property (nonatomic) double amount;
@property (nonatomic, strong) NSNumber * _Nullable subtotal;
@property (nonatomic, strong) NSNumber * _Nullable tax;
@property (nonatomic, strong) NSNumber * _Nullable tip;
@property (nonatomic, copy) NSDate * _Nonnull date;
@property (nonatomic, copy) NSString * _Nonnull category;
@property (nonatomic, copy) NSString * _Nullable customCategoryName;
@property (nonatomic, copy) NSString * _Nullable tagsText;
...
@property (nonatomic, copy) NSString * _Nullable lineItemsText;
